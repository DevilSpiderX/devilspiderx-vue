      ...
      <div id="center-fa" class="col-sm-10 col-md-7 col-lg-6 col-xl-5 shadow">
        <form @submit.prevent="form_submit">
          ...
          <div class="row justify-content-around">
            ...
            <router-link to="/register" class="btn btn-success btn-lg">注 册</router-link>
          </div>
        </form>
      </div>
    </div>
...
<script>
import {changeThemeColor} from "@/js/global";
...
export default {
  ...
  mounted() {
    ...
    window.document.body.style.backgroundColor = "#DCDCDC";
